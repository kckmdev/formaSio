                    ...
                    <div class="overflow-x-auto rounded-t-lg">
                        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                            <thead class="ltr:text-left rtl:text-right">
                                <tr>
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Nom Utilisateur</th>
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Formation</th>
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Date Inscription</th>
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Etat</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach ($inscriptions as $inscription)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                            {{ $inscription->session->formation->intitule ?? 'Formation inconnue' }}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                            {{ optional($inscription->created_at)->format('d/m/Y') ?? 'Date inconnue' }}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 ">
                                           {{ $inscription->etat }}
                                        </td>
