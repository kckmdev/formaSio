<nav class="flex items-center justify-between flex-wrap bg-gray-800 p-3 text-white">
    ...
    <div class="flex justify-end">
        <ul class="flex">
            ...
            @if(Auth::check()) 
                <li class="mr-6">
                    <a href="{{ route('user.profile')}}" class="text-white font-bold bg-green-500 px-4 py-2 rounded-full hover:bg-green-600">Profil de {{ Auth::user()->nom }}</a>
                </li>
                <li class="mr-6">
            ...
            @else
                ...
                <li class="mr-6"><a href="{{ route('login')}}">Connexion</a></li>
            @endif
        </ul>
    </div>
</nav>
